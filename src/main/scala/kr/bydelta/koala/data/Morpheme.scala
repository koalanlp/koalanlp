...
final class Morpheme private(val id: Int, val surface: String, val rawTag: String, val tag: POSTag) extends Serializable {
...
object Morpheme {
  /**
    * Create a Morpheme.
    *
    * @param id      Index of this morpheme in the word.
    ...
    */
  def apply(id: Int, surface: String, rawTag: String, tag: POSTag) =
  new Morpheme(id, surface, rawTag, tag)
