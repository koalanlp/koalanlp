 ...
 *    Java와 Scala에서 `kr.bydelta.koala.proc.ProcUtil`의 Static Member로 참조됩니다.
 *
 ...
 * * [kr.bydelta.koala.PhraseTag] 구구조의 형태 분류를 갖는 Enum 값
 *
 * @since 2.0.0
 */
 ...
 * * [DepTree] 의존구조를 저장하는 형태
 * * [kr.bydelta.koala.PhraseTag] 의존구조의 형태 분류를 갖는 Enum 값 (구구조 분류와 같음)
 * * [kr.bydelta.koala.DependencyTag] 의존구조의 기능 분류를 갖는 Enum 값
 *
 * @since 2.0.0
 */
 ...
 * * [kr.bydelta.koala.RoleType] 의미역 분류를 갖는 Enum 값
 *
 * @since 2.0.0
 */
 ...
 * * [Entity] 개체명을 저장하는 형태
 * * [kr.bydelta.koala.CoarseEntityType] [Entity]의 대분류 개체명 분류구조 Enum 값
 *
 * @since 2.0.0
 */
