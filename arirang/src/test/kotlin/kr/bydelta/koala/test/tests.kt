...
class ArirangDictTest : Spek(DictSpek(Dictionary))

class ArirangTaggerTest : Spek(TaggerSpek(getTagger = init@{ Tagger() },
        tagParaByOrig = orig@{ emptyList() },
        tagSentByOrig = sent@{
        ...
        tagSentByKoala = koala@{ str, tagger ->
